...
public class VentanaBuscar extends JFrame implements ActionListener {
        ...
        private Coordinador miCoordinador; //objeto miCoordinador 
	//que permite la relacion entre esta clase y la clase coordinador
	...
	public VentanaBuscar() {
		...
		textCod.setBounds(90, 80, 80, 25);
		add(textCod);
		
		textNombre=new JTextField();
		textNombre.setBounds(90, 120, 190, 25);
		add(textNombre);

		textTelefono=new JTextField();
		textTelefono.setBounds(360, 160, 80, 25);
		add(textTelefono);
		
		textProfesion=new JTextField();
		textProfesion.setBounds(90, 160, 190, 25);
		add(textProfesion);
		
		textEdad=new JTextField();
		textEdad.setBounds(360, 120, 80, 25);
		add(textEdad);
	...
	public void actionPerformed(ActionEvent e) 
	{
		...
		{if (!textCod.getText().equals(""))
			...
			}else{ JOptionPane.showMessageDialog(null, "Ingrese un numero de documento", "Información",JOptionPane.WARNING_MESSAGE);	}
	 ...
	 * @param bEliminar
	 */
	public void habilita(boolean codigo, boolean nombre, 
		boolean edad, boolean tel, boolean profesion,
