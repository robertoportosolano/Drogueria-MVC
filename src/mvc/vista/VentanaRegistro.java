...
public class VentanaRegistro extends JFrame implements ActionListener{
	...
	private Coordinador miCoordinador; //objeto miCoordinador que permite la relacion 
	//entre esta clase y la clase coordinador
	...
	public VentanaRegistro() {
		...
		textTelefono.setBounds(360, 160, 100, 25);
		add(textTelefono);
